...
enum class SafetyVerdict {
    SAFE,           // E < 1e-6: On critical line
    NOMINAL,        // E < 1e-4: Near critical line
    CAUTION,        // E < 1e-2: Drifting from critical line
    UNSAFE,         // E >= 1e-2: Far from critical line
...
class ASIOSGuard {
    ...
    fun assessSafety(embedding: DoubleArray): SafetyAssessment {
        ...
        val safetyScore = kotlin.math.exp(-energy * 1000)
