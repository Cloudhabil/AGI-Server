% BSD Gap 6 Crystallization - Cycle 6
% Vector: infinity_folding
% Generated: 2026-01-05T02:42:48.011537
...
\begin{align*}
    \text{Euler Systems} &: 4.00% \\
    \text{Derived AG} &: 4.00% \\
    \text{Infinity Folding} &: 4.00%
\end{align*}
