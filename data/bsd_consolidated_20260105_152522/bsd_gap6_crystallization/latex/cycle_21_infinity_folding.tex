% BSD Gap 6 Crystallization - Cycle 21
% Vector: infinity_folding
% Generated: 2026-01-05T02:42:49.671054
...
\begin{align*}
    \text{Euler Systems} &: 14.00% \\
    \text{Derived AG} &: 14.00% \\
    \text{Infinity Folding} &: 14.00%
\end{align*}
