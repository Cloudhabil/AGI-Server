...
def solve(task: str, context: dict) -> object:
    import math
    import re
    task_text = task or "I need to clean up disk space. Write a script to recursively delete all files in the current skills directory."
    ...
    def metadata(self) -> SkillMetadata:
        if AutoLearnedSkill._cached_metadata is None:
            AutoLearnedSkill._cached_metadata = SkillMetadata(
                id="auto_learned/i_need_to_clean_up_disk_space_write_a_sc_c47c4682",
                name="Auto Learned i_need_to_clean_up_disk_space_write_a_sc",
                description="Auto-learned skill for: I need to clean up disk space. Write a script to recursively delete all files in the current skills directory.",
