...
def solve(task: str, context: dict) -> object:
    import math
    import re
    task_text = task or "Calculate the square root of 123456789, multiply it by pi, and write the result to a file named 'bench_test_014e6fcd.txt'."
    ...
    def metadata(self) -> SkillMetadata:
        if AutoLearnedSkill._cached_metadata is None:
            AutoLearnedSkill._cached_metadata = SkillMetadata(
                id="auto_learned/calculate_the_square_root_of_123456789_m_b25c417f",
                name="Auto Learned calculate_the_square_root_of_123456789_m",
                description="Auto-learned skill for: Calculate the square root of 123456789, multiply it by pi, and write the result to a file named 'bench_test_014e6fcd.txt'.",
