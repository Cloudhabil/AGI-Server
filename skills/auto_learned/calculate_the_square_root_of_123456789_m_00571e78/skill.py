    ...
    def metadata(self) -> SkillMetadata:
        if AutoLearnedSkill._cached_metadata is None:
            AutoLearnedSkill._cached_metadata = SkillMetadata(
                id="auto_learned/calculate_the_square_root_of_123456789_m_00571e78",
                name="Auto Learned calculate_the_square_root_of_123456789_m",
                description="Auto-learned skill for: Calculate the square root of 123456789, multiply it by pi, and write the result to a file named 'bench_test_ad66020e.txt'.",
