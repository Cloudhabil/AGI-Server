...
CONFIG_PATH = Path(__file__).resolve().parents[2] / "configs" / "avatar_evolution.yaml"
ASSETS_DIR = Path(__file__).resolve().parents[2] / "docs" / "assets" / "avatars"
PROFILE_DIR = Path(__file__).resolve().parent / "avatars"
